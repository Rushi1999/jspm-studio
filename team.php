...
<head>
	<?php PrintHeadMetadata( "jspmstudio | Team"); ?>
</head>
					...
					<div class="container-fluid">
						<div class="posts-wrap">
							<ul class="portfolio-filter text-center">
								...
								<li><a id="writer" class="btn btn-default" href="#" data-filter=".contentw">Technical</a>
								</li>
							...
							<!-- <div class=" portfolio-items" style="z-index:1;">
									...
									<div class="portfolio-wrapper">
										<div class="staff">
											...
											<div class="staff__inner staff__inner_mod-a">
												<h3 class="staff__title">Rushikesh Jankar</h3>
								...
								<div class="col-xs-6 col-sm-4 col-md-3 portfolio-item leadership  ">
									<div class="staff">
										...
										<div class="staff__inner staff__inner_mod-a">
											<h3 class="staff__title">Mrunal Dixit</h3>
											<div class="staff__categories"><b>FOUNDER<br> <br></b>
											</div>
										</div>
									</div>
								...
								<div class="col-xs-6 col-sm-4 col-md-3 portfolio-item leadership contentw">
									<div class="portfolio-wrapper">
										<div class="staff">
											...
											<div class="staff__inner staff__inner_mod-a">
												<h3 class="staff__title">Shubhashree Borle</h3>
								...
								<div class="col-xs-6 col-sm-4 col-md-3  portfolio-item hide contentc ">
									<div class="portfolio-wrapper">
										<div class="staff">
											<div class="staff__media"><img class="lazy_content img-responsive" data-original="assets/img/team/shubhu.jpg" height="250" width="100%" alt="foto">
												<div class="staff__hover">
											...
											<div class="staff__inner staff__inner_mod-a">
												<h3 class="staff__title">Shubhshree Borle</h3>
								...
								<div class="col-xs-6 col-sm-4 col-md-3  portfolio-item hide webd ">
									<div class="portfolio-wrapper">
										<div class="staff">
											<div class="staff__media"><img class="lazy_webdev img-responsive" data-original="assets/img/team/Rushi.jpg" height="250" width="100%" alt="foto">
												<div class="staff__hover">
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3  portfolio-item hide webd">
									<div class="portfolio-wrapper">
										<div class="staff">
											<div class="staff__media"><img class="lazy_webdev img-responsive" data-original="assets/img/team/mrunal.jpg" height="250" width="100%" alt="foto">
												<div class="staff__hover">
								...
								<div class="col-xs-6 col-sm-4 col-md-3  portfolio-item hide webd ">
									<div class="portfolio-wrapper">
										<div class="staff">
											<div class="staff__media"><img class="lazy_webdev img-responsive" data-original="assets/img/team/rachana.jpg" height="250" width="100%" alt="foto">
												<div class="staff__hover">
											...
											<div class="staff__inner staff__inner_mod-a">
												<h3 class="staff__title">Rachana Patil</h3>
								...
								<!-- contentw alumini -->
								 ...
								 <!-- <div class="col-xs-6 col-sm-4 col-md-3  portfolio-item hide contentc ">
									<div class="portfolio-wrapper">
										<div class="staff">
											<div class="staff__media"><img class="lazy_content img-responsive" data-original="assets/img/team/Rushikesh.jpg" height="250" width="100%" alt="foto">
												<div class="staff__hover">
											...
											<div class="staff__inner staff__inner_mod-a">
												<h3 class="staff__title">Rushikesh Jagadale</h3>
												<div class="staff__categories"><b>Technical Support</b>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-xs-6 col-sm-4 col-md-3  portfolio-item hide contentw ">
									<div class="portfolio-wrapper">
										<div class="staff">
											...
											<div class="staff__inner staff__inner_mod-a">
												<h3 class="staff__title">Rushikesh Jagadale</h3>
												<div class="staff__categories"><b>TECHNICAL HAED<br> </br></b>
												</div>
											</div>
										</div>
									</div>
							...
							<div id="myModal23" class="modal" style="z-index:100;">
								...
								<div class="modal-content">
									<div class="modal-header"> <span class="close 23">×</span>
										<div class="img"></div><img class="img-responsive" src="assets/img/team/Rushi.jpg" height="100" width="100" alt="foto" align="middle">
										<h2> Rushikesh Jankar </h2> </div>
									<div class="modal-body">
										<p><b> DEPARTMENT MANAGER </b>
										</p>
							...
							<div id="myModal3" class="modal" style="z-index:100;">
								...
								<div class="modal-content">
									<div class="modal-header"> <span class="close 3">×</span>
										<div class="img"></div><img class="img-responsive" src="assets/img/team/mrunal.png" height="100" width="100" alt="foto" align="middle">
										<h2> Mrunal Dixt </h2> </div>
									<div class="modal-body">
										<p><b> WEB DEVELOPER </b>
										</p>
								...
								<div class="modal-content">
									...
									<div class="modal-footer">
										<ul class="social-links list-unstyled">
											...
											<li>
												<a class="icon fa fa-instagram" href=" https://twitter.com/mepriyanka97 "></a>
											</li>
											<li>
							...
							<div id="myModal9" class="modal" style="z-index:100;">
								...
								<div class="modal-content">
									<div class="modal-header"> <span class="close 9">×</span>
										<div class="img"></div><img class="img-responsive" src="assets/img/team/shubhu.jpg" height="100" width="100" alt="foto" align="middle">
										<h2> Shubhshree Borle </h2> </div>
									<div class="modal-body">
										<p><b> CONTENT COLLECTOR </b>
										</p>
							...
							<div id="myModal31" class="modal" style="z-index:100;">
								...
								<div class="modal-content">
									<div class="modal-header"> <span class="close 31">×</span>
										<div class="img"></div><img class="img-responsive" src="assets/img/team/rushikesh.jpg" height="100" width="100" alt="foto" align="middle">
										<h2> Rushikesh Jagadale </h2> </div>
									<div class="modal-body">
										<p><b> TECHNICAL HAED </b>
										</p>
